...
export class Backend implements backendInterface {
    ...
    async addEntry(arg0: string, arg1: number, arg2: number, arg3: number, arg4: number, arg5: string, arg6: number, arg7: bigint, arg8: number, arg9: number): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addEntry(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async clearEntries(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearEntries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
